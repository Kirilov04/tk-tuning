      ...
      >
        <div className="z-10 mt-32 w-full max-w-full md:basis-3/5">
          ...
          >
            ...
            <motion.p
              className={`mt-4 ${isMobile ? 'text-center' : 'text-left'} text-sm ${isDarkMode ? 'text-red-400' : 'text-black'} transition-opacity duration-500 ${scrolling ? 'opacity-0' : 'opacity-100'}`}
            >
        ...
        <div className="flex basis-3/5 justify-center md:ml-40 md:mt-16 md:justify-end">
          <motion.img
            className={`${isMobile ? 'mx-auto w-40' : 'md:w-62 md:-mt-20'}`}
